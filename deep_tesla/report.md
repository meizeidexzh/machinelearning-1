...
VGG16模型共有1亿3千万个参数，输入图形长宽不能小于48x48，卷积核的大小都为3x3，共有5个卷积层，每层的深度分别为64x2、128x2、256x2、512x3、512x3。每层之间使用了2x2的最大池化层。
...
![](C:\machinelearning\deep_tesla\images\model.png)
...
- _如果将你最终模型作为新的基准，你认为还能有更好的解决方案吗？
